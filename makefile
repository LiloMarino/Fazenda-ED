...
# Arquivos fonte
FONTES = main.c radialtree.c geo-qry.c svg.c dot.c Bibliotecas/path.c Bibliotecas/utilities.c Bibliotecas/listadupla.c Bibliotecas/arqsvg.c Bibliotecas/learquivo.c Bibliotecas/geradores.c
